...
import { LayoutDashboard, Shield, FileText, Settings, Activity, LogOut } from 'lucide-react';
            ...
            <div className="p-4 border-t border-slate-800">
                <div className="bg-slate-800/50 rounded-xl p-4 mb-4">
                    <div className="flex items-center gap-3 mb-3">
                        ...
                        <span className="text-xs font-medium text-slate-300">System Status: Online</span>
                    </div>
                    <div className="w-full bg-slate-700 h-1.5 rounded-full overflow-hidden">
                        <div className="bg-blue-500 h-full w-3/4" />
                    </div>
                    <p className="text-[10px] text-slate-500 mt-2">Privacy Budget: 75% remaining</p>
                </div>
